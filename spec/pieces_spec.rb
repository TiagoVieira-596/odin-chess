...
describe King do
  ...
  context 'finds possible moves' do
    ...
    it 'includes castle moves' do
      ...
      expect(king_moves.possible_moves([4, 0], board_moves)).to match_array([[3, 0], [3, 1], [4, 1], [5, 1], [5, 0], [0,6]])
    end
    it 'finds all the 8 possible moves' do
      ...
      expect(king_moves.possible_moves([4, 1], board_moves)).to match_array([[3, 1], [3, 2], [4, 2], [5, 2], [5, 1], [5, 0], [4, 0], [3, 0]])
    end
  end
end